...
@section('title', 'Seller Shop Search')
@section('content')
                                                    ...
                                                    <a href="{{ route('item.details', $item->id) }}"
                                                        ...
                                                        <div class="card mt-3">
                                                            <img src="{{ asset('storage/item_images/' . $item->image) }}"
                                                                ...
                                                                alt="image">
                                                            <div class="card-body"
                                                                style="background: rgb(220, 231, 231);">
                                                                <h6 class="card-title text-capitalize">{{ $item->name }}
                                                                ...
                                                                <p class="card-text text-primary fs-6">$ {{ $item->price
                                                                    }}</p>
                                                                <div>
                                                                    ...
                                                                    <span class="fs-6 d-sm-inline d-block">{{
