                ...
                <div class="col-md-10 offset-md-1 my-sm-4">
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb fw-bold fs-6">
                            ...
                            <li class="breadcrumb-item active text-primary" aria-current="page">{{ $category->name }}
                            </li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="col-md-10 offset-md-1">
                    <div class="row">
                        ...
                        <div class="col-md-4 order-md-1">
                            <h6>Filter By
                                <a href="{{ route('home.clear') }}" class="text-danger text-decoration-none float-end">Clear Filter</a>
                            </h6>
